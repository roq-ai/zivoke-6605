...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['project-manager', 'owner', 'team-member', 'stakeholder'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Timeline', path: '/timelines', entity: 'timeline', service: AccessServiceEnum.PROJECT, icon: FiCalendar },
